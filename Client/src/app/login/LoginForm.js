...
>
  ...
  >
    ...
    >
      ...
      {/*}
      <Box sx={{textAlign: "center",margin:4, gap:1, padding:5,display:'flex', flexDirection:'column'}}>
      <Card>
            <CardContent>
        ...
        <Card>
            <CardContent>
              <Typography variant="h5" color="primary">User-friendly</Typography>
              <Typography variant="body2" color="textSecondary">
    ...
    >
      ...
      <Card style={{ position: 'relative' }}>
            <CardContent>
              ...
              <Typography variant="body2" color="textSecondary">The 2024 ACM/IEEE Joint Conference on Digital Libraries (JCDL ’24)</Typography>
              <Typography variant="body2" color="textSecondary">Dec 2024</Typography>
            </CardContent>
            <RouterLink 
    href="https://drive.google.com/file/d/10dRq7IHV4vtft5KVVWSscgYTDC0oGFoX/view?usp=drive_link" 
    target="_blank" 
